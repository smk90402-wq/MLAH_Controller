...
namespace MLAH_Controller
{
    ...
    /// 임무 정보
    /// </summary>
    public partial class InputMissionPackageJson : CommonBase
    {
        public void Clear()
        {
            MessageID = 51310;
    ...
    /// 지점/지역의 수
    /// </summary>
    public partial class RegionInfo : CommonBase
    {
        public void Clear()
        {
            RegionType = 0;
    ...
    public partial class MissionReferencePackage : CommonBase
    {
        ...
        private uint _RegionInfosN = 0;
        /// <summary>
        /// 지역/지점의 수
        /// </summary>
        public uint RegionInfosN
        {
            get
            {
                return _RegionInfosN;
            }
            set
            {
                _RegionInfosN = value;
                OnPropertyChanged("RegionInfosN");
            }
        }

        private ObservableCollection<RegionInfo> _RegionInfo = new ObservableCollection<RegionInfo>();
        /// <summary>
        /// 무인기 귀환 위치 정보
        /// </summary>
        public ObservableCollection<RegionInfo> RegionInfo
        {
            get
            {
                return _RegionInfo;
    ...
    public partial class MissionSegmentLAH : CommonBase
    {
        ...
        private uint _IndividualMissionLisnN = 0;
        /// <summary>
        /// 해당 협업기저임무 구간에서 수행될 개별임무(IndividualMission)의 수
        /// </summary>
        public uint IndividualMissionLisnN
        {
            get
            {
                return _IndividualMissionLisnN;
            }
            set
            {
                _IndividualMissionLisnN = value;
                OnPropertyChanged("IndividualMissionLisnN");
            }
        }
    ...
    public partial class WaypointLAH : CommonBase
    {
        ...
        /// </summary>
        private uint _WaypoinID = 0;
        public uint WaypoinID
        {
            get
            {
                return _WaypoinID;
    ...
    public partial class WaypointUAV : CommonBase
    {
        public void Clear()
        {
            ...
            NextWaypointID = 0;
            WaypointPassType = 0;
            LoiterProperty = new LoiterProperty(); // 객체는 null로 초기화
            FilmingProperty = new FilmingProperty(); // 객체는 null로 초기화
        }
        private uint _WaypoinID = 0;
        /// <summary>
        /// 경로점 식별자 (200,000,000 ~ 299,999,999)
        ...
        private LoiterProperty _LoiterProperty = new LoiterProperty();
        /// <summary>
        ...
        private FilmingProperty _FilmingProperty = new FilmingProperty();
        /// <summary>
    ...
    public class MissionResultData
    {
        ...
        public long Timestamp { get; set; } // 5바이트지만 C#에선 long(8바이트)으로 처리

        // Payload (MissionResults)
        public uint SystemRecommend { get; set; } // 1: 다음, 2: 재수행, 3: 완료
    ...
    public class SBC2Status
    {
        public uint MessageID = 52100;
        /// <summary>
        /// Presence Vector (고정값 0x00)
        /// </summary>
        public byte PresenceVector { get; } = 0x00;
