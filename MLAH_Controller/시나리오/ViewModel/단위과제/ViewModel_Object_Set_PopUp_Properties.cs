...
{
    public partial class ViewModel_Object_Set_PopUp : CommonBase
    {
        ...
        private int _LAH1HealthStatus = 1;
        public int LAH1HealthStatus
        {
            get
            {
                return _LAH1HealthStatus;
            }
            set
            {
                _LAH1HealthStatus = value;
                OnPropertyChanged("LAH1HealthStatus");
            }
        }

        private int _LAH1FuelWarning = 1;
        public int LAH1FuelWarning
        {
            ...
            set
            {
                ...
                OnPropertyChanged("LAH1FuelWarning");
            }
        }
        ...
        private int _LAH2HealthStatus = 1;
        public int LAH2HealthStatus
        {
            get
            {
                return _LAH2HealthStatus;
            }
            set
            {
                _LAH2HealthStatus = value;
                OnPropertyChanged("LAH2HealthStatus");
            }
        }

        private int _LAH2FuelWarning = 1;
        public int LAH2FuelWarning
        {
            ...
            set
            {
                ...
                OnPropertyChanged("LAH2FuelWarning");
            }
        }
        ...
        private int _LAH3HealthStatus = 1;
        public int LAH3HealthStatus
        {
            get
            {
                return _LAH3HealthStatus;
            }
            set
            {
                _LAH3HealthStatus = value;
                OnPropertyChanged("LAH3HealthStatus");
            }
        }

        private int _LAH3FuelWarning = 1;
