...
namespace MLAH_Controller
{
    ...
    /// </summary>
    public partial class View_AlertPopUp : ThemedWindow
    {
        ...
        // 시간을 파라미터로 받는 생성자
        public View_AlertPopUp(double seconds)
        {
            InitializeComponent();
            this.countdownSeconds = seconds;
            InitializeTimer();
            this.Left = 1600;
            this.Top = 300; // 원하는 Top 위치
        }

        public View_AlertPopUp(double seconds,int width)
        {
            InitializeComponent();
            this.countdownSeconds = seconds;
            this.Width = width;
