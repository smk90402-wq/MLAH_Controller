...
namespace MLAH_LogAnalyzer
{
    ...
    /// </summary>
    public partial class View_Unit_Map_SR : UserControl
    {
        private static View_Unit_Map_SR _instance;

        public static View_Unit_Map_SR SingletonInstance
        {
            get
            {
                if (_instance == null)
        ...
        public View_Unit_Map_SR()
        {
            //ServicePointManager.SecurityProtocol |= SecurityProtocolType.Tls12;
            InitializeComponent();
            this.DataContext = ViewModel_Unit_Map_SR.SingletonInstance;
