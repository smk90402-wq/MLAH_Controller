...
namespace MLAH_LogAnalyzer
{
    ...
    /// </summary>
    public partial class View_Unit_Map_Safety : UserControl
    {
        private static View_Unit_Map_Safety _instance;

        public static View_Unit_Map_Safety SingletonInstance
        {
            get
            {
                if (_instance == null)
        ...
        public View_Unit_Map_Safety()
        {
            //ServicePointManager.SecurityProtocol |= SecurityProtocolType.Tls12;
            InitializeComponent();
            var _ = new DevExpress.Xpf.Map.MapControl();
            this.DataContext = ViewModel_Unit_Map_Safety.SingletonInstance;
        ...
        private void MapControl_MouseMove(object sender, System.Windows.Input.MouseEventArgs e)
        {
            ...
            //    if (cp == null) return;
            //    ViewModel_Unit_Map_Safety.SingletonInstance.MapCursorLat = cp.GetY();
            //    ViewModel_Unit_Map_Safety.SingletonInstance.MapCursorLon = cp.GetX();
            //    return;
            //}
            ...
            double lat = finalCp.GetY();
            double lon = finalCp.GetX();

            // 1. 위도/경도 업데이트
            var vm = ViewModel_Unit_Map_Safety.SingletonInstance;
            vm.MapCursorLat = lat;
            vm.MapCursorLon = lon;
        ...
        {
            if (ViewModel_Unit_Map_Safety.SingletonInstance.MapCoordinateSystem == null)
            {
                ViewModel_Unit_Map_Safety.SingletonInstance.MapCoordinateSystem = this.mapControl.CoordinateSystem;
            }
