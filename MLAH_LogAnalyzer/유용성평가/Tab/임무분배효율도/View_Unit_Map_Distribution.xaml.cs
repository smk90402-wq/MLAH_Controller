...
namespace MLAH_LogAnalyzer
{
    ...
    /// </summary>
    public partial class View_Unit_Map_Distribution : UserControl
    {
        private static View_Unit_Map_Distribution _instance;

        public static View_Unit_Map_Distribution SingletonInstance
        {
            get
            {
                if (_instance == null)
        ...
        public View_Unit_Map_Distribution()
        {
            //ServicePointManager.SecurityProtocol |= SecurityProtocolType.Tls12;
            InitializeComponent();
            this.DataContext = ViewModel_Unit_Map_Distribution.SingletonInstance;
